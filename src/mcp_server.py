...
class MCPAcademicServer:
    ...
    def call_tool(self, tool_name: str, arguments: Dict[str, Any]) -> Dict[str, Any]:
        ...
        """
        # --------------------------------------------------------------------------
        # TODO 2.1 ✅ ĐÃ HOÀN THIỆN — MCP JSON-RPC 2.0
        # 1. Gọi dispatch_tool_call(tool_name, arguments) để thực thi tool.
        # 2. Chuyển chuỗi JSON kết quả thành Python Dictionary (json.loads).
        # 3. Đóng gói và trả về Dict theo chuẩn MCP JSON-RPC 2.0.
        # --------------------------------------------------------------------------
